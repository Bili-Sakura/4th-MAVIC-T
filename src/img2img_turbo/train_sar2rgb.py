#!/usr/bin/env python
"""Train Pix2Pix-Turbo for **sar2rgb** (SAR → RGB).

Usage::

    # Single GPU
    python -m src.img2img_turbo.train_sar2rgb

    # Multi-GPU via accelerate
    accelerate launch -m src.img2img_turbo.train_sar2rgb --train_batch_size 4
...
from src.img2img_turbo.config import sar2rgb_config, TaskConfig  # noqa: E402
from src.img2img_turbo.trainer import Pix2PixTurboTrainer  # noqa: E402


def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train Pix2Pix-Turbo – sar2rgb")
