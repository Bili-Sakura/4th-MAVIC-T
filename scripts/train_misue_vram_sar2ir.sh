#!/usr/bin/env bash
# misue-vram — SAR→IR — Latent-space modelling (frozen VAE), small config
...
NGPU="${NGPU:-1}"
LOG_DIR="./logs"
LOG_FILE="${LOG_DIR}/train_misue_vram_sar2ir.log"
...
OUTPUT_DIR="./ckpt/misue-vram/misue-vram_sar2ir"
