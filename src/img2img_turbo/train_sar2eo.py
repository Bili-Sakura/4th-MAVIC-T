...
Usage::
    ...
    # Single GPU
    python -m src.img2img_turbo.train_sar2eo

    # Multi-GPU via accelerate
    accelerate launch -m src.img2img_turbo.train_sar2eo --train_batch_size 8
...
from src.img2img_turbo.config import sar2eo_config, TaskConfig  # noqa: E402
