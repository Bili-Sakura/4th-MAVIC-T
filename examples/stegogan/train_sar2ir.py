...
"""Train StegoGAN baseline for **sar2ir** (SAR → IR).

Usage::

    python -m examples.stegogan.train_sar2ir
    accelerate launch -m examples.stegogan.train_sar2ir --train_batch_size 4
"""
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train StegoGAN – sar2ir")
