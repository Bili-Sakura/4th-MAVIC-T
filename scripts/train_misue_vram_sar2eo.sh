#!/usr/bin/env bash
# misue-vram — SAR→EO — Latent-space modelling (frozen VAE), small config
# DDBM small config for reduced VRAM usage
...
NGPU="${NGPU:-1}"
LOG_DIR="./logs"
LOG_FILE="${LOG_DIR}/train_misue_vram_sar2eo.log"
...
OUTPUT_DIR="./ckpt/misue-vram/misue-vram_sar2eo"
