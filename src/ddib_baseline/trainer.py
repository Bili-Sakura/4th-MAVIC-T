...
:class:`~src.ddib_baseline.config.TaskConfig` and can monkey-patch / sub-class
...
from .schedulers import DDIBScheduler
...
class DDIBTrainer:
    ...
    Typical usage inside a per-task script::
        ...
        from src.ddib_baseline.config import sar2eo_config
