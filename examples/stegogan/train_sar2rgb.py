...
"""Train StegoGAN baseline for **sar2rgb** (SAR → RGB).

Usage::

    python -m examples.stegogan.train_sar2rgb
    accelerate launch -m examples.stegogan.train_sar2rgb --train_batch_size 4
"""
...
from .trainer import StegoGANTrainer  # noqa: E402
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train StegoGAN – sar2rgb")
