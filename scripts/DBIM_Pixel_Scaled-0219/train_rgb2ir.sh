#!/usr/bin/env bash
# DBIM-Pixel-Scaled-0219 — RGB→IR — Pixel-space DBIM (no VAE)
# Large config, (1024, 1024) per roadmap (Stage 3 scaling).
#
# Usage:
#   bash scripts/DBIM_Pixel_Scaled-0219/train_rgb2ir.sh
#   CUDA_VISIBLE_DEVICES=0 bash scripts/DBIM_Pixel_Scaled-0219/train_rgb2ir.sh
#   NGPU=4 bash scripts/DBIM_Pixel_Scaled-0219/train_rgb2ir.sh
...
OUTPUT_DIR="./ckpt/DBIM_Pixel_Scaled-0219/rgb2ir"

# --- SwanLab ---
SWANLOG_DIR="./ckpt/swanlog"
SWANLAB_EXPERIMENT_NAME="dbim-pixel-scaled-rgb2ir"
SWANLAB_DESCRIPTION="DBIM Pixel Scaled RGB→IR (1024, large)"
