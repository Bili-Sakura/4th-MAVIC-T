...
"""Train StegoGAN baseline for **rgb2ir** (RGB → IR).

Usage::

    python -m examples.stegogan.train_rgb2ir
    accelerate launch -m examples.stegogan.train_rgb2ir --train_batch_size 4
"""
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train StegoGAN – rgb2ir")
