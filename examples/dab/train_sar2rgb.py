...
"""Train DAB baseline for sar2rgb."""
...
from .trainer import DABTrainer  # noqa: E402
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train DAB – sar2rgb")
