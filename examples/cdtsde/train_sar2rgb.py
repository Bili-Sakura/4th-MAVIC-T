...
"""Train CDTSDE baseline for sar2rgb."""
...
from .trainer import CDTSDETrainer  # noqa: E402
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train CDTSDE – sar2rgb")
