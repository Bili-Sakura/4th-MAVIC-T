...
Usage::
    ...
    # Single GPU
    python -m src.ddbm_baseline.train_sar2rgb

    # Multi-GPU via accelerate
    accelerate launch -m src.ddbm_baseline.train_sar2rgb --train_batch_size 4
...
from src.ddbm_baseline.config import sar2rgb_config, TaskConfig  # noqa: E402
from src.ddbm_baseline.trainer import DDBMTrainer  # noqa: E402
