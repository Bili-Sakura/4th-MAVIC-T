#!/usr/bin/env python
"""Train BiBBDM baseline for **sar2ir** (SAR → IR, 1-band → 1-band, 1024×1024).

Usage::

    # Single GPU
    python -m src.bibbdm_baseline.train_sar2ir

    # Multi-GPU via accelerate
    accelerate launch -m src.bibbdm_baseline.train_sar2ir --train_batch_size 4
...
from src.bibbdm_baseline.config import sar2ir_config, TaskConfig  # noqa: E402
from src.bibbdm_baseline.trainer import BiBBDMTrainer  # noqa: E402


def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train BiBBDM – sar2ir")
