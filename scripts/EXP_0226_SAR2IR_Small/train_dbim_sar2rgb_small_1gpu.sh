#!/usr/bin/env bash
# EXP-0226 — DBIM — SAR→RGB — Small tier (1 GPU)
#
# Same config as train_dbim_sar2rgb_small_8gpu.sh but single-GPU. Smaller batch.
#
# Usage:
#   bash scripts/EXP_0226_SAR2IR_Small/train_dbim_sar2rgb_small_1gpu.sh
...
LOG_FILE="${LOG_DIR}/train_dbim_sar2rgb_small_1gpu.log"
mkdir -p "${LOG_DIR}"
...
OUTPUT_DIR="./ckpt/EXP_0226_SAR2IR_Small/dbim/sar2rgb_small_512_1gpu"
RESUME_FROM_CHECKPOINT="${RESUME_FROM_CHECKPOINT:-}"

# --- SwanLab ---
SWANLOG_DIR="./ckpt/swanlog"
SWANLAB_EXPERIMENT_NAME="exp-0226-sar2rgb-small-512-1gpu"
SWANLAB_DESCRIPTION="EXP-0226 DBIM SAR→RGB Small (512, ~29.6M, 1 GPU)"
SWANLAB_TAGS="dbim,exp-0226,sar2rgb,small,1gpu"
