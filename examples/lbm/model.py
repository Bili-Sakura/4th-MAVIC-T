...
Provides :func:`create_lbm_model` (and backward-compatible alias
:func:`create_model`) which builds a UNet backbone configured for LBM.
...
LBMUNet = UNet2DWrapper
EDMLBMUNet = EDMUNet2D
VDMLBMUNet = VDMUNet2D
...
def create_lbm_model(
    ...
    **kwargs: Any,
    ...
    """Factory for LBM-compatible UNet models.
    ...
    cls = _LBM_CLASS_MAP[backbone_type]
