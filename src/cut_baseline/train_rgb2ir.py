...
Usage::
    ...
    # Single GPU
    python -m src.cut_baseline.train_rgb2ir

    # Multi-GPU via accelerate
    accelerate launch -m src.cut_baseline.train_rgb2ir --train_batch_size 4
...
from src.cut_baseline.config import rgb2ir_config, TaskConfig  # noqa: E402
