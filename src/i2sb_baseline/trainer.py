...
their own :class:`~src.i2sb_baseline.config.TaskConfig` and can monkey-patch / sub-class any
...
from .schedulers import I2SBScheduler
...
class I2SBTrainer:
    ...
    Typical usage inside a per-task script::
        ...
        from src.i2sb_baseline.config import sar2eo_config
