...
def main():
    ...
    ckpt_path = args.pretrained_model_name_or_path or args.source_pretrained_path or "N/A"
    checkpoint_config = load_checkpoint_config(ckpt_path) if ckpt_path != "N/A" else {}
    extra_sampling = [
    ...
    detailed_description = build_detailed_description(
        model_name="DDIB",
        model_description="DDIB (Denoising Diffusion Implicit Bridge) - dual diffusion models with shared latent. PyTorch implementation.",
