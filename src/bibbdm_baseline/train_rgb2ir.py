#!/usr/bin/env python
"""Train BiBBDM baseline for **rgb2ir** (RGB → IR, 3-band → 1-band, 1024×1024).

Usage::

    # Single GPU
    python -m src.bibbdm_baseline.train_rgb2ir

    # Multi-GPU via accelerate
    accelerate launch -m src.bibbdm_baseline.train_rgb2ir --train_batch_size 4
...
from src.bibbdm_baseline.config import rgb2ir_config, TaskConfig  # noqa: E402
from src.bibbdm_baseline.trainer import BiBBDMTrainer  # noqa: E402


def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train BiBBDM – rgb2ir")
