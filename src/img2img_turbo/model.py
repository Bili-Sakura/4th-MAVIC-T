...
# ---------------------------------------------------------------------------
# Custom VAE forward functions (skip-connection aware)
# ---------------------------------------------------------------------------

def _vae_encoder_fwd(self, sample: torch.Tensor) -> torch.Tensor:
    """Custom VAE encoder forward that stores intermediate activations."""
...
def _vae_decoder_fwd(self, sample: torch.Tensor, latent_embeds=None) -> torch.Tensor:
    """Custom VAE decoder forward that accepts skip connections."""
    sample = self.conv_in(sample)
