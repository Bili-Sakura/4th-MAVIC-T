...
class MavicTDDBMDataset(Dataset):
    ...
    load_size : int or None
        ...
        When None and image is large enough, direct random crop from original.
    model_channels : int
    ...
    def __getitem__(self, idx: int) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        use_resize_and_crop = use_resize_mode and self.load_size is not None and self.load_size > self.resolution
