...
Usage::
    ...
    # Single GPU
    python -m src.cut_baseline.train_sar2rgb

    # Multi-GPU via accelerate
    accelerate launch -m src.cut_baseline.train_sar2rgb --train_batch_size 4
...
from src.cut_baseline.config import sar2rgb_config, TaskConfig  # noqa: E402
from src.cut_baseline.trainer import CUTTrainer  # noqa: E402
