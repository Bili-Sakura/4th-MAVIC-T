...
Usage::
    ...
    # Single GPU
    python -m src.cut_baseline.train_sar2eo

    # Multi-GPU via accelerate
    accelerate launch -m src.cut_baseline.train_sar2eo --train_batch_size 8
...
from src.cut_baseline.config import sar2eo_config, TaskConfig  # noqa: E402
