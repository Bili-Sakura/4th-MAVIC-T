#!/usr/bin/env bash
# EXP-0226 — DBIM — SAR→IR — Small tier (1 GPU)
#
# Same config as train_dbim_sar2ir_small_8gpu.sh but single-GPU. Smaller batch.
#
# Usage:
...
LOG_FILE="${LOG_DIR}/train_dbim_sar2ir_small_1gpu.log"
mkdir -p "${LOG_DIR}"
...
OUTPUT_DIR="./ckpt/EXP_0226_SAR2IR_Small/dbim/sar2ir_small_512_1gpu"
RESUME_FROM_CHECKPOINT="${RESUME_FROM_CHECKPOINT:-}"

# --- SwanLab ---
SWANLOG_DIR="./ckpt/swanlog"
SWANLAB_EXPERIMENT_NAME="exp-0226-sar2ir-small-512-1gpu"
SWANLAB_DESCRIPTION="EXP-0226 DBIM SAR→IR Small (512, ~29.6M, 1 GPU)"
SWANLAB_TAGS="dbim,exp-0226,sar2ir,small,1gpu"
