...
from src.models.unet.unet_2d import UNet2DWrapper as BiBBDMUNet  # noqa: E402
from examples.bibbdm.model import create_model  # noqa: E402
...
def _load_pipeline(
    ...
    if path.is_dir():
        ...
        pipeline = BiBBDMPipeline.from_pretrained(
        ...
        if ema_unet_dir.is_dir():
            ...
            pipeline.unet = BiBBDMUNet.from_pretrained(
...
def main():
    ...
    detailed_description = build_detailed_description(
        model_name="BiBBDM",
        model_description="BiBBDM (Bidirectional Brownian Bridge Diffusion Model) - Brownian Bridge diffusion for image-to-image translation. PyTorch implementation.",
