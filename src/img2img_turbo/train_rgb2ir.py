#!/usr/bin/env python
"""Train Pix2Pix-Turbo for **rgb2ir** (RGB → IR).

Usage::

    # Single GPU
    python -m src.img2img_turbo.train_rgb2ir

    # Multi-GPU via accelerate
    accelerate launch -m src.img2img_turbo.train_rgb2ir --train_batch_size 4
...
from src.img2img_turbo.config import rgb2ir_config, TaskConfig  # noqa: E402
from src.img2img_turbo.trainer import Pix2PixTurboTrainer  # noqa: E402


def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train Pix2Pix-Turbo – rgb2ir")
