#!/usr/bin/env python
"""Train I2SB baseline for **sar2eo** (SAR → EO, 1-band 256×256).

Usage::

    # Single GPU
    python -m src.i2sb_baseline.train_sar2eo

    # Multi-GPU via accelerate
    accelerate launch -m src.i2sb_baseline.train_sar2eo --train_batch_size 64
...
from src.i2sb_baseline.config import sar2eo_config, TaskConfig  # noqa: E402
from src.i2sb_baseline.trainer import I2SBTrainer  # noqa: E402


def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train I2SB – sar2eo")
