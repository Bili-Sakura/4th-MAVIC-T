#!/usr/bin/env python
"""Train BDBM baseline for sar2rgb."""
...
from .trainer import BDBMTrainer  # noqa: E402
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train BDBM – sar2rgb")
