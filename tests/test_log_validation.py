...
ALL_CONFIGS = [DdbmConfig, DbimConfig, CdtsdeConfig, BibbdmConfig, BdbmConfig, I2sbConfig, DdibConfig, CutConfig, TurboConfig]
...
from examples.cdtsde.trainer import CDTSDETrainer
...
class TestLogValidationMethodExists:
    ...
    def test_cdtsde_has_log_validation(self):
        assert callable(getattr(CDTSDETrainer, "log_validation", None))
