#!/usr/bin/env bash
# EXP-0226 — DBIM — SAR→RGB — Small tier (match SAR2EO success config)
#
# Same small architecture as sar2ir: num_channels=64, channel_mult="1,2,3,4,4",
# attention_resolutions="", ~29.6M params. Trains at 512×512 (crop from 1024).
#
# Usage:
#   bash scripts/EXP_0226_SAR2IR_Small/train_dbim_sar2rgb_small_8gpu.sh
#   NGPU=8 bash scripts/EXP_0226_SAR2IR_Small/train_dbim_sar2rgb_small_8gpu.sh
...
LOG_FILE="${LOG_DIR}/train_dbim_sar2rgb_small_8gpu.log"
mkdir -p "${LOG_DIR}"
...
OUTPUT_DIR="./ckpt/EXP_0226_SAR2IR_Small/dbim/sar2rgb_small_512"
RESUME_FROM_CHECKPOINT="${RESUME_FROM_CHECKPOINT:-}"

# --- SwanLab ---
SWANLOG_DIR="./ckpt/swanlog"
SWANLAB_EXPERIMENT_NAME="exp-0226-sar2rgb-small-512"
SWANLAB_DESCRIPTION="EXP-0226 DBIM SAR→RGB Small (512, ~29.6M, 5-stage for 512px)"
SWANLAB_TAGS="dbim,exp-0226,sar2rgb,small"
