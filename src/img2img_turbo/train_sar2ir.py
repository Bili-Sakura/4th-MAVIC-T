#!/usr/bin/env python
"""Train Pix2Pix-Turbo for **sar2ir** (SAR → IR).
...
from src.img2img_turbo.config import sar2ir_config, TaskConfig  # noqa: E402
from src.img2img_turbo.trainer import Pix2PixTurboTrainer  # noqa: E402


def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train Pix2Pix-Turbo – sar2ir")
