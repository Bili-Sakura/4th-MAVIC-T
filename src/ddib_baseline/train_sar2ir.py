...
Usage::
    ...
    # Single GPU
    python -m src.ddib_baseline.train_sar2ir

    # Multi-GPU via accelerate
    accelerate launch -m src.ddib_baseline.train_sar2ir --train_batch_size 4
...
from src.ddib_baseline.config import sar2ir_config, TaskConfig  # noqa: E402
