...
\begin{tcolorbox}[colback=mainquestionbg, colframe=mainquestionframe, title=\textbf{Insight 1: Placeholder}]
\TODO{Add insight on diffusion bridge vs. standard diffusion for cross-modality translation.}
\end{tcolorbox}

\begin{tcolorbox}[colback=mainquestionbg, colframe=mainquestionframe, title=\textbf{Insight 2: Placeholder}]
\TODO{Add insight on resolution scaling and multi-stage training for 1024px tasks.}
\end{tcolorbox}

\begin{tcolorbox}[colback=mainquestionbg, colframe=mainquestionframe, title=\textbf{Insight 3: Placeholder}]
\TODO{Add insight on dataset quality and preprocessing choices.}
\end{tcolorbox}

\begin{tcolorbox}[colback=mainquestionbg, colframe=mainquestionframe, title=\textbf{Insight 4: Placeholder}]
\TODO{Add insight on inference efficiency and sampling step trade-offs.}
\end{tcolorbox}
