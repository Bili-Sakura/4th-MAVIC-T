...
"""DINO-based structural similarity loss.

Ported from ``vendor/Img2Image-Turbo/src/my_utils/dino_struct.py``.

Provides :class:`VitExtractor` for extracting intermediate features from a
DINO ViT model and :class:`DinoStructureLoss` for computing a self-similarity
based structural consistency loss between image pairs.
"""
...
def attn_cosine_sim(x, eps=1e-08):
    """Compute pairwise cosine similarity of token embeddings."""
    x = x[0]
...
class VitExtractor:
    """Extract intermediate features from a DINO ViT model via forward hooks."""
...
class DinoStructureLoss:
    """Structural similarity loss based on DINO ViT self-similarity maps."""
