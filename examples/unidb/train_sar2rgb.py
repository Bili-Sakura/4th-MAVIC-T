#!/usr/bin/env python
"""Train UniDB baseline for sar2rgb."""
...
from .config import sar2rgb_config, TaskConfig
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train UniDB – sar2rgb")
