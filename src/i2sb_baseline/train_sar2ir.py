#!/usr/bin/env python
"""Train I2SB baseline for **sar2ir** (SAR → IR, 1-band → 1-band, 1024×1024).

Usage::

    # Single GPU
    python -m src.i2sb_baseline.train_sar2ir

    # Multi-GPU via accelerate
    accelerate launch -m src.i2sb_baseline.train_sar2ir --train_batch_size 4
...
from src.i2sb_baseline.config import sar2ir_config, TaskConfig  # noqa: E402
from src.i2sb_baseline.trainer import I2SBTrainer  # noqa: E402


def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train I2SB – sar2ir")
