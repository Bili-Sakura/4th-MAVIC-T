...
"""Train StegoGAN baseline for **sar2eo** (SAR → EO).

Usage::

    # Single GPU
    python -m examples.stegogan.train_sar2eo

    # Multi-GPU via accelerate
    accelerate launch -m examples.stegogan.train_sar2eo --train_batch_size 4
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train StegoGAN – sar2eo")
