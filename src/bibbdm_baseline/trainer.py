...
as :mod:`src.ddbm_baseline.trainer`.  Per-task scripts instantiate the
trainer with their own :class:`~src.bibbdm_baseline.config.TaskConfig`.
"""
...
from .schedulers import BiBBDMScheduler
...
class BiBBDMTrainer:
    ...
    Typical usage inside a per-task script::
        ...
        from src.bibbdm_baseline.config import sar2eo_config
