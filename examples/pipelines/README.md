...
Self-contained diffusion pipelines for MAVIC-T models. **No external project code required** — use these for inference without the full `src/` tree.
...
ckpt_path = "./ckpt/exp3/stage1_sar2eo/ddbm/sar2eo/checkpoint-10000"
...
# Note: model_index.json in the checkpoint must point to components in this module
# or use the direct import pattern above for full self-containment
