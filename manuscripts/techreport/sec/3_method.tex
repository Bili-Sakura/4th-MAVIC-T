...
\subsubsection{Bridge Design and Training}
\label{sec:dbim-bridge}
...
\subsubsection{Architecture and Channel Handling}
\label{sec:dbim-arch}
...
\begin{figure}[h]
    \centering
    \includegraphics[page=3,width=\columnwidth]{../submission/figures/Figures.pdf}
