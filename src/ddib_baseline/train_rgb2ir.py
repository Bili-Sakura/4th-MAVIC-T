...
Usage::
    ...
    # Single GPU
    python -m src.ddib_baseline.train_rgb2ir

    # Multi-GPU via accelerate
    accelerate launch -m src.ddib_baseline.train_rgb2ir --train_batch_size 4
...
from src.ddib_baseline.config import rgb2ir_config, TaskConfig  # noqa: E402
from src.ddib_baseline.trainer import DDIBTrainer  # noqa: E402


def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train DDIB – rgb2ir")
