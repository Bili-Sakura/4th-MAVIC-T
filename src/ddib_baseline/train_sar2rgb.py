#!/usr/bin/env python
"""Train DDIB baseline for **sar2rgb** (SAR → RGB, 1-band → 3-band, 1024×1024).
...
Usage::
    ...
    # Single GPU
    python -m src.ddib_baseline.train_sar2rgb

    # Multi-GPU via accelerate
    accelerate launch -m src.ddib_baseline.train_sar2rgb --train_batch_size 4
...
from src.ddib_baseline.config import sar2rgb_config, TaskConfig  # noqa: E402
from src.ddib_baseline.trainer import DDIBTrainer  # noqa: E402


def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train DDIB – sar2rgb")
